...
public class LiveTestQuestion extends AppCompatActivity implements View.OnClickListener {
    ...
    private void submittest() {
        ...
        try {
            ...
            Call<String> call = RetrofitClient.getInstance().getMyApi().submitLiveTestResult(Preferences.get(context,Preferences.LIVESELECTEDPAPERID).toString(),Preferences.get(context,Preferences.USER_MOBILE).toString(),""+correct,""+total,""+unanswered,""+wrong);

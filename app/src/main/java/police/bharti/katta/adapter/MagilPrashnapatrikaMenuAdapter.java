...
public class MagilPrashnapatrikaMenuAdapter extends  RecyclerView.Adapter<MagilPrashnapatrikaMenuAdapter.DataObjectHolder>{
    ...
    public MagilPrashnapatrikaMenuAdapter(ArrayList<MagitPrashnPatrikaModel> productModels, Context context) {
...
/*            String serverpath = Constants.BASE_URL+"no-image.png";
            ...
            holder.ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Preferences.save(context,Preferences.SELECTEDMAGILPRASHNPATRIKAMENU,saravMenuModel.getId());
                    Intent intent=new Intent(context, MagilPrashnPatrika.class);

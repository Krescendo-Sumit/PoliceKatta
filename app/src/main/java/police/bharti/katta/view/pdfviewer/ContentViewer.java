...
public class ContentViewer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  String ff= Preferences.get(ContentViewer.this, Preferences.SELECTEDFILE).replace(" ","%20");
        String data=getIntent().getStringExtra("data");
        Toast.makeText(this, "Data is "+data, Toast.LENGTH_SHORT).show();
        webSettings.setJavaScriptEnabled(true);
        webSettings.setAllowFileAccess(true);
        webSettings.setAppCacheEnabled(true);
       // url= Constants.BASE_URL +"ContentViewers/index.php?fname="+ff;
    ...
    private class Browser_Home extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            Toast.makeText(ContentViewer.this, "Error Occur", Toast.LENGTH_SHORT).show();
//            finish();
//            Intent intent = new Intent(ContentViewer.this, ErroActivity.class);
//            startActivity(intent);
    ...
    private class ChromeClient extends WebChromeClient {
        ...
        public Bitmap getDefaultContentViewerPoster() {
            if (mCustomView == null) {
                return null;
            }

...
public class TestSeriesHeadingAdapter extends  RecyclerView.Adapter<TestSeriesHeadingAdapter.DataObjectHolder>{
    ...
    public TestSeriesHeadingAdapter(ArrayList<MagitPrashnPatrikaModel> productModels, Context context) {
...
/*            String serverpath = Constants.BASE_URL+"no-image.png";
            ...
            holder.ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(context, TestMasterMenu.class);

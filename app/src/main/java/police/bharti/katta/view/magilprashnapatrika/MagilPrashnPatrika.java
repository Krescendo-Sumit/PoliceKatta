...
public class MagilPrashnPatrika extends AppCompatActivity {
    MagilPrashnapatrikaAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magil_prashn_patrika);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
                WindowManager.LayoutParams.FLAG_SECURE);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        context = MagilPrashnPatrika.this;
                    ...
                    try {
                        if(response.body()!=null) {
                            ...
                            if (saravMenuModels != null || saravMenuModels.size() > 0) {
                                adapter = new MagilPrashnapatrikaAdapter((ArrayList) saravMenuModels, context);

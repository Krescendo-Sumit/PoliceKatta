...
public class ChaluGhdamodiSubHeadingAdapter extends  RecyclerView.Adapter<ChaluGhdamodiSubHeadingAdapter.DataObjectHolder>{
    ...
    public ChaluGhdamodiSubHeadingAdapter(ArrayList<ChaluGhadamodiModel> productModels, Context context) {

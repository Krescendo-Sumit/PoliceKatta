...
import police.bharti.katta.adapter.ChaluGhdamodiSubHeadingAdapter;
...
public class ChaluGhadamodiMenu_SubHeading extends AppCompatActivity {
    ChaluGhdamodiSubHeadingAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = ChaluGhadamodiMenu_SubHeading.this;
        ...
        id=Preferences.get(context,Preferences.SELECTEDCHALUGHADAMODIID);
...
//        progressDialog.getWindow().setGravity(Gravity.BOTTOM | Gravity.CENTER);
    ...
    private void getMenuList() {
        ...
        try {
            ...
            Call<List<ChaluGhadamodiModel>> call = RetrofitClient.getInstance().getMyApi().getChalughadaModiSubHeadingMenu(id,mobile);
                    ...
                    try {
                        if(response.body()!=null) {
                            ...
                            if (saravMenuModels != null || saravMenuModels.size() > 0) {
                                adapter = new ChaluGhdamodiSubHeadingAdapter((ArrayList) saravMenuModels, context);
                                rc_listofsaravmenu.setAdapter(adapter);
                            } else {
                                Toast.makeText(ChaluGhadamodiMenu_SubHeading.this, "माहिती उपलब्ध नाही.", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else{
                            Toast.makeText(ChaluGhadamodiMenu_SubHeading.this, "माहिती उपलब्ध नाही.", Toast.LENGTH_SHORT).show();

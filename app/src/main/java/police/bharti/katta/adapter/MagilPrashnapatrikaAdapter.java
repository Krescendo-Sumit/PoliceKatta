...
public class MagilPrashnapatrikaAdapter extends  RecyclerView.Adapter<MagilPrashnapatrikaAdapter.DataObjectHolder>{
    ...
    public MagilPrashnapatrikaAdapter(ArrayList<MagitPrashnPatrikaModel> productModels, Context context) {
        ...
        try {
            ...
            holder.ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Preferences.save(context,Preferences.SELECTEDMAGILPRASHNPATRIKA,saravMenuModel.getId());

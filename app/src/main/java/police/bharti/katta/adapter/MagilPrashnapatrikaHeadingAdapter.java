...
public class MagilPrashnapatrikaHeadingAdapter extends  RecyclerView.Adapter<MagilPrashnapatrikaHeadingAdapter.DataObjectHolder>{
    ...
    public MagilPrashnapatrikaHeadingAdapter(ArrayList<MagitPrashnPatrikaModel> productModels, Context context) {
...
/*            String serverpath = Constants.BASE_URL+"no-image.png";
            ...
            holder.ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Preferences.save(context,Preferences.SELECTEDMAGILPRASHNPATRIKAHEADING,saravMenuModel.getId());
                    Intent intent=new Intent(context, MagilPrashnPatrikaMenus.class);

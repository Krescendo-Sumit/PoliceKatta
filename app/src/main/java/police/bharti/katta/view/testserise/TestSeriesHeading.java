...
public class TestSeriesHeading extends AppCompatActivity {
    TestSeriesHeadingAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_series_heading);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,
                WindowManager.LayoutParams.FLAG_SECURE);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        context = TestSeriesHeading.this;
    ...
    private void getMenuList() {
        ...
        try {
            ...
            Call<List<MagitPrashnPatrikaModel>> call = RetrofitClient.getInstance().getMyApi().getTestSeriesHeading(jsonObject);
                    ...
                    try {
                        if(response.body()!=null) {
                            ...
                            if (saravMenuModels != null || saravMenuModels.size() > 0) {
                                adapter = new TestSeriesHeadingAdapter((ArrayList) saravMenuModels, context);
